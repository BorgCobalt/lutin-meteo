"""
Detourage IA (rembg) + creation d'icones PNG transparentes pour les vetements du Lutin.
"""
import os
...
def process_image(input_path, output_path, icon_size=400):
    """Remove background with AI, crop to content, resize to square icon."""
...
if __name__ == '__main__':
    input_dir = r"C:\Users\Nicolas\Desktop\Icones Lutin meteo\Habits Lutin Meteo\Pull-Overs"
    output_dir = r"C:\Users\Nicolas\ClaudeCodeLocal\lutin-meteo\assets\clothes\pulls"
    process_batch(input_dir, output_dir, "pull", icon_size=400)
